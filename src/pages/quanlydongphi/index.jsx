  ...
  return (
    <>
      ...
      <div className="container-haha">
        ...
        >
          <TabPanel header="Chưa đóng phí"></TabPanel>
          <TabPanel header="Đã đóng phí"></TabPanel>
          <TabPanel header="Tổng hợp"></TabPanel>
        </TabView>
              ...
              body={(rowData) => {
                return (
                  <span className={`product-badge status-${rowData.TrangThai}`}>
                    {rowData.TrangThai ? "Đã đóng phí" : "Chưa đóng phí"}
                  </span>
                );
              }}
            ></Column>
